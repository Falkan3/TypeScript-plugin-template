...
export class URLHelpers {
     ...
     * @public
     * @static
     * @param {String} url - url to remove the parameter from
     * @param {String} name - name of the parameter to remove from the url
     * @return {String} url without the specified query parameter
     */
    public static RemoveURLParameter(url: string = location.search, name: string) {
